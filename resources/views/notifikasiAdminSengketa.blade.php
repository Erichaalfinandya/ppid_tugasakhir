            ...
            <div class="col-md-12 grid-margin">
                <div class="d-flex justify-content-between flex-wrap">
                    <div class="me-md-3 me-xl-5">
                        <h2>Notifikasi Sengketa Informasi </h2>
                        <div class="d-flex">
                            <i class="mdi mdi-headset menu-icon"></i>
                            <p class="text-muted mb-0 hover-cursor">&nbsp;/&nbsp;Notifikasi&nbsp;/&nbsp;</p>
                            <p class="text-primary mb-0 hover-cursor">Notifikasi Sengketa Informasi</p>
                        </div>
                    </div>
                </div>
            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                @else
                                                    ...
                                                    <button class="btn" style="background-color: #1A374D; color: white;" data-toggle="modal" data-target="#uploadModal-{{ $data->id }}">Upload Data</button>
                                                @endif
                                            </td>
                                            <td>
                                        ...
                                        <div class="modal fade" id="uploadModal-{{ $data->id }}" tabindex="-1" role="dialog" aria-labelledby="uploadModalLabel-{{ $data->id }}" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{ route('admin.notifikasi-sengketa.uploadJawaban', $data->id) }}" method="POST" enctype="multipart/form-data">
                                                        @csrf
                                                        @method('PATCH')
