            ...
            <div class="container">
                <div class="row mb-5 justify-content-center">
                    <div class="mx-auto text-center mb-5" style="max-width: 900px;">
                        ...
                        <h1 class="mb-0">Profil Wakil Walikota Kota Surakarta</h1>
                    </div>
                </div>
                    ...
                    <div class="container">
                        <div class="row d-flex no-gutters">
                            <div class="col-md-6 col-lg-5 d-flex">
                                <div class="img-about img d-flex align-items-stretch" style="background-image:url('img/wakilwalikota.png');">
                                ...
                                <div class="py-md-5">
                                    <div class="row justify-content-start pb-3">
                                        <div class="col-md-12 heading-section ftco-animate">
                                            <span class="subheading">Wakil Walikota </span>
                                            <h2 class="mb-4" style="font-size: 34px; text-transform: capitalize;">Drs. Teguh Prakosa</h2>
                                            <p>Drs. Teguh Prakosa adalah politikus Partai Demokrasi Indonesia Perjuangan (PDIP). Ia menjabat sebagai Wakil Wali Kota Surakarta periode 2021-2024. Sebelumnya ia menjabat sebagai Anggota DPRD Surakarta tiga periode yakni 2009-2014, 2014-2019, dan 2019-2024.</p>
                                            <ul class="about-info mt-4 px-md-0 px-2">
                                                <li class="d-flex"><span>Nama:</span> <span>Drs. Teguh Prakosa</span></li>
                                                <li class="d-flex"><span>Tanggal Lahir:</span> <span>10 November 1959</span></li>
