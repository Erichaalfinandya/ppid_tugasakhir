...
<html lang="en">
    ...
    <body>
        ...
        @include('include.navbar-without-search')
                        ...
                        <!-- Daftar Informasi Publik Serta Merta Start -->
                <div class="container-fluid py-5">
                    <div class="container">
                        ...
                        <div class="align-items-center">
                            <h5 class="float-start">B.  INFORMASI WAJIB DIUMUMKAN SECARA SERTA MERTA</h5>
                        </div>
                        <div>
                                ...
                                <tbody>
                                    @foreach ($datas as $data)
                                        <tr>
                                            ...
                                            <td class="text-break"><a href="{{ url('pages/layanan/daftarinformasipubliksertamerta2/'.$data->id) }}">{{ $data->jenis_media }}</a></td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
