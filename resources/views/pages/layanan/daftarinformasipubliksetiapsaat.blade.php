...
<html lang="en">
    ...
    <body>
        ...
        @include('include.navbar-without-search')
                        ...
                        <!-- Daftar Informasi Publik Setiap Saat Start -->
                <div class="container-fluid py-5">
                    <div class="container">
                        <div class="row mb-5 justify-content-center">
                            <div class="mx-auto text-center mb-5" style="max-width: 900px;">
                                <h1 class="mb-0">Daftar Informasi Publik Tersedia Setiap Saat</h1>
                                <center>
                        ...
                        <div class="align-items-center">
                            <h5 class="float-start">C. INFORMASI WAJIB TERSEDIA SETIAP SAAT</h5>
                        </div>
                        <div>
                            <table id="example" class="table display" style="width:100%">
                                ...
                                @foreach ($datas as $data)
                                        <tr>
                                            ...
                                            <td class="text-break"><a href="{{ url('pages/layanan/daftarinformasipubliksetiapsaat2/'.$data->id) }}">{{ $data->jenis_media }}</a></td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
