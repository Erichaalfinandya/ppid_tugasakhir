            ...
            <div class="col-md-12 grid-margin">
                <div class="d-flex justify-content-between flex-wrap">
                    <div class="me-md-3 me-xl-5">
                        <h2>Notifikasi Keberatan Informasi </h2>
                        <div class="d-flex">
                            <i class="mdi mdi-headset menu-icon"></i>
                            <p class="text-muted mb-0 hover-cursor">&nbsp;/&nbsp;Notifikasi&nbsp;/&nbsp;</p>
                            <p class="text-primary mb-0 hover-cursor">Notifikasi Keberatan Informasi</p>
                        </div>
                    </div>
                </div>
            </div>
                                        ...
                                        <div class="modal fade" id="uploadModal-{{ $data->id }}" tabindex="-1" role="dialog" aria-labelledby="uploadModalLabel-{{ $data->id }}" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{ route('admin.notifikasi-keberatan.uploadJawaban', $data->id) }}" method="POST" enctype="multipart/form-data">
                                                        @csrf
                                                        @method('PATCH')
                                            ...
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="nik{{ $data->id }}">NIK/No. Identitas</label>
                                                        ...
                                                        <div class="form-group">
                                                            <label for="rincianinformasi{{ $data->id }}">Alasan Pengajuan Keberatan</label>
                                                            <textarea class="form-control" id="rincianinformasi{{ $data->id }}" rows="3" readonly>{{ $data->alasan_pengajuan }}</textarea>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="tujuaninformasi{{ $data->id }}">Kasus Posisi (Ringkasan Mengenai Kasus)</label>
                                                            <input type="text" class="form-control" id="tujuaninformasi{{ $data->id }}" value="{{ $data->kasusposisi }}" readonly>
                                                        </div>
                                                        <div class="form-group">
