...
@section('content')
            ...
            <div class="d-flex justify-content-between flex-wrap">
                <div class="d-flex align-items-end flex-wrap">
                    <div class="me-md-3 me-xl-5">
                        <h2>Daftar Informasi - Edit data</h2>
                        <div class="d-flex">
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('daftar-informasi.update', ['id' => $data->id]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="" placeholder="Masukkan Kategori Judul"
                        name="kategori_judul" value="{{ $data->kategoriJudul->judul }}" readonly required>
                </div>
                <input type="hidden" name="judul_id" value="{{ $data->judul_id }}">
                <div class="form-group">
                    ...
                    <textarea name="ringkasan_informasi" class="form-control" id="" cols="30" rows="10"
                        placeholder="Ringkasan Informasi" required>{{ $data->ringkasan_informasi }}</textarea>
                </div>
                <div class="form-group">
