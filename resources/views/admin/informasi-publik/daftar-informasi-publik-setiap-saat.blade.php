    ...
    <div class="row">
            ...
            <div class="col-md-12 grid-margin">
                <div class="d-flex justify-content-between flex-wrap">
                    <div class="me-md-3 me-xl-5">
                        <h2>Daftar Informasi Publik Setiap Saat</h2>
                        <div class="d-flex">
                            <i class="mdi mdi-headset menu-icon"></i>
                            <p class="text-muted mb-0 hover-cursor">&nbsp;/&nbsp;Layanan&nbsp;/&nbsp;</p>
                            <p class="text-primary mb-0 hover-cursor">Daftar Informasi Publik Setiap Saat</p>
                        </div>
                    </div>
                            ...
                            <table class="table table-striped" id="data-tables">
                                <thead class="text-center">
                                    <tr>
                                        ...
                                        <th class="align-middle">Jenis Informasi</th>
                                        <th class="align-middle">Ringkasan Informasi</th>
                                        <th class="align-middle">Pejabat Yang Menguasai Informasi</th>
                                        <th class="align-middle">Penanggung Jawab Informasi</th>
                                        <th class="align-middle">Waktu Pembuatan Informasi</th>
                                        <th class="align-middle">Bentuk Informasi Yang Tersedia</th>
                                        <th class="align-middle">Jangka Waktu Penyimpanan</th>
                                        <th class="align-middle">Jenis Media Yang Memuat</th>
                                        {{-- @if (auth()->check() && auth()->user()->name === 'admin') --}}
                                ...
                                <tbody>
                                    @foreach ($datas as $data)
                                        <tr>
                                            ...
                                            <td><span>{{ $data->jenisInfo->nama }}</span>
        ...
        <!-- Modal -->
            <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <form action="{{ route('daftar-informasi-setiap-saat.store') }}" method="POST">
                    @csrf
                    @method('POST')
