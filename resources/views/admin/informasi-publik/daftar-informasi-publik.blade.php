...
@section('content')
    <div class="row">
                ...
                <div class="d-flex justify-content-between flex-wrap">
                    <div class="me-md-3 me-xl-5">
                        ...
                        <div class="d-flex">
                            ...
                            <p class="text-primary mb-0 hover-cursor">Daftar Informasi Publik Berkala</p>
                        </div>
                    </div>
        ...
        <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <form action="{{ route('informasi-publik.daftar-informasi-publik.store') }}" method="POST">
                @csrf
                @method('POST')
