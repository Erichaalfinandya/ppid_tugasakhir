...
@section('content')
            ...
            <div class="d-flex justify-content-between flex-wrap">
                <div class="d-flex align-items-end flex-wrap">
                    <div class="me-md-3 me-xl-5">
                        <h2>Daftar {{ $data->kategori->pembagian_informasi }} - Edit data</h2>
                        <div class="d-flex">
                            <i class="mdi mdi-headset menu-icon"></i>
                            <p class="text-muted mb-0 hover-cursor">&nbsp;/&nbsp;Layanan&nbsp;/&nbsp;</p>
                            <p class="text-muted mb-0 hover-cursor">&nbsp;/&nbsp;Daftar {{ $data->kategori->pembagian_informasi }}&nbsp;/&nbsp;</p>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('daftar-judul.update', ['id' => $data->id]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="form-group">
                    <label for="exampleFormControlInput1">Kategori</label>
                    <input type="text" class="form-control" id="" placeholder="Masukkan Kategori"
                        name="nama" value="{{ $data->kategori->nama }}" readonly required>
                </div>
