...
@section('content')
            ...
            <div class="d-flex justify-content-between flex-wrap">
                <div class="d-flex align-items-end flex-wrap">
                    <div class="me-md-3 me-xl-5">
                        <h2>Berita Pemerintah - Edit data</h2>
                        <div class="d-flex">
                            <i class="mdi mdi-newspaper menu-icon"></i>
                            <p class="text-muted mb-0 hover-cursor">&nbsp;/&nbsp;Berita&nbsp;/&nbsp;</p>
                            <p class="text-muted mb-0 hover-cursor">&nbsp;/&nbsp;Berita Pemerintah&nbsp;/&nbsp;</p>
    ...
    <div class="card">
        <div class="card-body">
            <form id="form" action="{{ route('berita_pemerintah.update', ['berita_pemerintah' => $berita->id]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="penerbit" placeholder="Masukkan Penerbit"
                        name="penerbit" value="{{ old('penerbit', $berita->penerbit) }}" required>
                    @error('penerbit')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
                <input type="hidden" name="pembagian_informasi" value="{{ $berita->pembagian_informasi }}">
                <div class="form-group">
