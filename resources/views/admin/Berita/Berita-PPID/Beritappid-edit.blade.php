...
@section('content')
            ...
            <div class="d-flex justify-content-between flex-wrap">
                <div class="d-flex align-items-end flex-wrap">
                    <div class="me-md-3 me-xl-5">
                        <h2>Berita PPID - Edit data</h2>
                        <div class="d-flex">
                            <i class="mdi mdi-newspaper menu-icon"></i>
                            <p class="text-muted mb-0 hover-cursor">&nbsp;/&nbsp;Berita&nbsp;/&nbsp;</p>
                            <p class="text-muted mb-0 hover-cursor">&nbsp;/&nbsp;Berita PPID&nbsp;/&nbsp;</p>
    ...
    <div class="card">
        <div class="card-body">
            <form id="form" action="{{ route('berita_ppid.update', ['berita_ppid' => $berita->id]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
