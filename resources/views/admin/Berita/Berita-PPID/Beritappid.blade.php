    ...
    <div class="row">
                ...
                <div class="d-flex align-items-end flex-wrap">
                    <div class="me-md-3 me-xl-5">
                        ...
                        <div class="d-flex">
                            ...
                            <p class="text-primary mb-0 hover-cursor">Berita PPID</p>
                        </div>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center">
                                                    <a href="{{ route('berita_ppid.edit', ['berita_ppid' => $data->id]) }}" class="btn btn-sm btn-warning text-white py-1 mr-1">
                                                        <span class="mdi mdi-pen"></span>
                                                    </a>
                                                    <form id="deleteForm-{{ $data->id }}" action="{{ route('berita_ppid.destroy', ['berita_ppid' => $data->id]) }}" method="POST" class="m-0">
                                                        @csrf
                                                        @method('DELETE')
        ...
        <!-- Modal -->
            <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <form id="form" action="{{ route('berita_ppid.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id=""
                                        placeholder="Masukkan kategori" name="penerbit" required>
                                </div>
                                <div class="form-group">
