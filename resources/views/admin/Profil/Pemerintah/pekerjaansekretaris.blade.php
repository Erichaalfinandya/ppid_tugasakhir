    ...
    <div class="row">
            ...
            <div class="d-flex justify-content-between flex-wrap">
                <div class="d-flex align-items-end flex-wrap">
                    <div class="me-md-3 me-xl-5">
                        <h2> Riwayat Pekerjaan Sekretaris Pemerintah Surakarta</h2>
                        <div class="d-flex">
                            <i class="mdi mdi-file menu-icon"></i>
                            <p class="text-muted mb-0 hover-cursor">&nbsp;/&nbsp;Sekretaris Pemerintah&nbsp;/&nbsp;</p>
                            <p class="text-primary mb-0 hover-cursor">Riwayat Pekerjaan Sekretaris Pemerintah Surakarta</p>
                        </div>
                    </div>
                </div>
            </div>
                                            ...
                                            {{-- @if (auth()->check() && auth()->user()->name === 'admin') --}}
                                                <td>
                                                    <div class="d-flex justify-content-center">
                                                        <a href="{{ route('pekerjaan_sekretaris.edit', ['pekerjaan_sekretaris' => $pekerjaan->id]) }}" class="btn btn-sm btn-warning text-white py-1 mr-1">
                                                            <span class="mdi mdi-pen"></span>
                                                        </a>
                                                        <form id="deleteForm-{{ $pekerjaan->id }}" action="{{ route('pekerjaan_sekretaris.destroy', ['pekerjaan_sekretaris' => $pekerjaan->id]) }}" method="POST" class="m-0">
                                                            @csrf
                                                            @method('DELETE')
        ...
        <!-- Modal -->
            <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <form id="form" action="{{ route('pekerjaan_sekretaris.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="masa" name="masa" placeholder="Masukkan riwayat masa jabatan pekerjaan sekretaris pemerintah surakarta" required>
                                </div>
                                <div class="form-group">
                                    <label for="jabatan">Posisi Jabatan</label>
                                    <input type="text" class="form-control" id="jabatan" name="jabatan" placeholder="Masukkan data riwayat posisi jabatan sekretaris pemerintah surakarta" required>
                                </div>
                                <div class="form-group">
