    ...
    <div class="row">
            ...
            <div class="d-flex justify-content-between flex-wrap">
                <div class="d-flex align-items-end flex-wrap">
                    <div class="me-md-3 me-xl-5">
                        <h2> Riwayat Pendidikan Sekretaris Pemerintah Surakarta</h2>
                        <div class="d-flex">
                            <i class="mdi mdi-file menu-icon"></i>
                            <p class="text-muted mb-0 hover-cursor">&nbsp;/&nbsp;Sekretaris Pemerintah&nbsp;/&nbsp;</p>
                            <p class="text-primary mb-0 hover-cursor">Riwayat Pendidikan Sekretaris Pemerintah</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row mt-2 py-3 justify-content">
            <div class="col-auto">
                ...
                <a href="{{ Route('pendidikan_sekretaris.index') }}" class="btn btn-primary" style="margin-right: 10px;">
                    Riwayat Pendidikan
                </a>
            </div>
            <div class="col-auto">
                <!-- Tombol untuk halaman pendidikan walikota -->
                <a href="{{ Route('pekerjaan_sekretaris.index') }}" class="btn btn-secondary">
                    Riwayat Pekerjaan
                </a>
            </div>
        </div>
                            ...
                            <table class="table table-striped" id="data-tables2">
                                <thead class="text-center">
                                    <tr>
                                        ...
                                        <th scope="col" class="align-middle text-center">Jenjang Pendidikan</th>
                                        <th scope="col" class="align-middle text-center">Nama Sekolah/Universitas</th>
                                            ...
                                            {{-- @if (auth()->check() && auth()->user()->name === 'admin') --}}
                                                <td>
                                                    <div class="d-flex justify-content-center">
                                                        <a href="{{ route('pendidikan_sekretaris.edit', ['pendidikan_sekretaris' => $pendidikan->id]) }}" class="btn btn-sm btn-warning text-white py-1 mr-1">
                                                            <span class="mdi mdi-pen"></span>
                                                        </a>
                                                        <form id="deleteForm-{{ $pendidikan->id }}" action="{{ route('pendidikan_sekretaris.destroy', ['pendidikan_sekretaris' => $pendidikan->id]) }}" method="POST" class="m-0">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="button" class="btn btn-sm btn-danger text-white py-1" data-toggle="modal" data-target="#confirmModal" data-status="{{ $pendidikan->jenjang }}" data-id="{{ $pendidikan->id }}">
        ...
        <!-- Modal -->
            <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <form id="form" action="{{ route('pendidikan_sekretaris.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Tambah Data Riwayat Pendidikan Sekretaris Pemerintah</h5>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="pendidikan" name="pendidikan" placeholder="Masukkan data riwayat pendidikan sekretaris pemerintah" required>
                                </div>
                                <div class="form-group">
                                    <label for="deskripsi">Deskripsi</label>
                                    <textarea class="form-control" id="deskripsi" name="deskripsi" placeholder="Masukkan deskripsi riwayat sekretaris pemerintah"></textarea>
                                </div>
                                <div class="form-group">
