    ...
    <div class="row">
            ...
            <div class="d-flex justify-content-between flex-wrap">
                <div class="d-flex align-items-end flex-wrap">
                    <div class="me-md-3 me-xl-5">
                        <h2> Misi Pemerintah Kota Surakarta</h2>
                        <div class="d-flex">
                            <i class="mdi mdi-file menu-icon"></i>
                            <p class="text-muted mb-0 hover-cursor">&nbsp;/&nbsp;Misi Pemerintah&nbsp;/&nbsp;</p>
                            <p class="text-primary mb-0 hover-cursor">Kota Surakarta</p>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <table class="table table-striped" id="data-tables2">
                                <thead class="text-center">
                                    <tr>
                                        ...
                                        <th scope="col" class="align-middle text-center">Misi</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center">
                                                    ...
                                                    <a href="{{ route('misi_pemerintah.edit', ['misi_pemerintah' => $misi->id]) }}" class="btn btn-sm btn-warning text-white py-1 mr-1">
                                                        <span class="mdi mdi-pen"></span>
                                                    </a>
                                                    <form id="deleteForm-{{ $misi->id }}" action="{{ route('misi_pemerintah.destroy', ['misi_pemerintah' => $misi->id]) }}" method="POST" class="m-0">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="button" class="btn btn-sm btn-danger text-white py-1" data-toggle="modal" data-target="#confirmModal" data-status="{{ $misi->urutan }}" data-id="{{ $misi->id }}">
        ...
        <!-- Modal -->
            <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <form id="form" action="{{ route('misi_pemerintah.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Tambah Data Misi Pemerintah</h5>
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="urutan" name="urutan" placeholder="Masukkan urutan misi pemerintah kota surakarta" required>
                                </div>
                                <div class="form-group">
                                    <label for="misi">Misi</label>
                                    <input type="text" class="form-control" id="misi" name="misi" placeholder="Masukkan misi pemerintah kota surakarta"></textarea>
                                </div>
                                <div class="form-group">
