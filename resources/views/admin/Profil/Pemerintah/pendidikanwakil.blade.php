    ...
    <div class="row">
            ...
            <div class="d-flex justify-content-between flex-wrap">
                <div class="d-flex align-items-end flex-wrap">
                    <div class="me-md-3 me-xl-5">
                        <h2> Riwayat Pendidikan Wakil Walikota Surakarta</h2>
                        <div class="d-flex">
                            <i class="mdi mdi-file menu-icon"></i>
                            <p class="text-muted mb-0 hover-cursor">&nbsp;/&nbsp;Wakil Walikota&nbsp;/&nbsp;</p>
                            <p class="text-primary mb-0 hover-cursor">Riwayat Pendidikan Walikota Surakarta</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped" id="data-tables2">
                                ...
                                <tbody>
                                    @foreach ($pendidikanwakil as $pendidikan)
                                        <tr>
                                            ...
                                            {{-- @if (auth()->check() && auth()->user()->name === 'admin') --}}
                                                <td>
                                                    <div class="d-flex justify-content-center">
                                                        <a href="{{ route('pendidikan_wakil.edit', ['pendidikan_wakil' => $pendidikan->id]) }}" class="btn btn-sm btn-warning text-white py-1 mr-1">
                                                            <span class="mdi mdi-pen"></span>
                                                        </a>
                                                        <form id="deleteForm-{{ $pendidikan->id }}" action="{{ route('pendidikan_wakil.destroy', ['pendidikan_wakil' => $pendidikan->id]) }}" method="POST" class="m-0">
                                                            @csrf
                                                            @method('DELETE')
        ...
        <!-- Modal -->
            <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <form id="form" action="{{ route('pendidikan_wakil.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Tambah Data Riwayat Pendidikan Wakil Walikota</h5>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="pendidikan" name="pendidikan" placeholder="Masukkan data riwayat pendidikan wakil walikota surakarta" required>
                                </div>
                                <div class="form-group">
