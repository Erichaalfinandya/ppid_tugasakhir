    ...
    <div class="row">
            ...
            <div class="d-flex justify-content-between flex-wrap">
                <div class="d-flex align-items-end flex-wrap">
                    <div class="me-md-3 me-xl-5">
                        <h2>Profil Dasar Hukum</h2>
                        <div class="d-flex">
                            <i class="mdi mdi-account menu-icon"></i>
                            <p class="text-muted mb-0 hover-cursor">&nbsp;/&nbsp;Profil&nbsp;/&nbsp;</p>
                            <p class="text-primary mb-0 hover-cursor">&nbsp;/&nbsp;Profil Dasar Hukum&nbsp;/&nbsp;</p>
                        </div>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                    <div class="d-flex justify-content-center">
                                                        <a href="{{ route('profildasarhukum.edit', ['id' => $datas->id]) }}"
                                                            type="submit" class="btn btn-sm btn-warning text-white py-1 mr-1">
                                                            <span class="mdi mdi-pen"></span>
                                                        </a>
                                                        <form id="deleteForm-{{ $datas->id }}" action="{{ route('profildasarhukum.destroy', ['id' => $datas->id]) }}" method="POST" class="m-0">
                                                            @csrf
                                                            @method('DELETE')
        ...
        {{-- @if (auth()->check() && auth()->user()->name === 'admin') --}}
            ...
            <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <form action="{{ route('profildasarhukum.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
