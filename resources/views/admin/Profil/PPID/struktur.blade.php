            ...
            <div class="d-flex justify-content-between flex-wrap">
                <div class="d-flex align-items-end flex-wrap">
                    <div class="me-md-3 me-xl-5">
                        <h2>Profil Struktur Organisasi - Edit data</h2>
                        <div class="d-flex">
                            <i class="mdi mdi-account menu-icon"></i>
                            <p class="text-muted mb-0 hover-cursor">&nbsp;/&nbsp;Profil&nbsp;/&nbsp;</p>
                            <p class="text-muted mb-0 hover-cursor">&nbsp;/&nbsp;Profil Struktur Organisasi&nbsp;/&nbsp;</p>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('profilppid.update', ['id' => $data->id]) }}" method="POST" enctype="multipart/form-data">
                ...
                <input type="hidden" name="jenis_ppid" value="struktur">
